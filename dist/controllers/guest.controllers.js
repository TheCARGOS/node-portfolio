...
exports.postMessage = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var body, newMessage;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                body = _a.sent();
                if (!(body && body.name && body.email && body.phone && body.subject && body.description)) return [3 /*break*/, 3];
